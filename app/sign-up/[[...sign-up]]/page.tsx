...
export default function SignUpPage() {
  return (
    <div className="auth-dark min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-950">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_20%_50%,rgba(99,102,241,0.15),transparent)]" />
      ...
      <div className="relative z-10 w-full max-w-md px-4 flex flex-col items-center">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-blue-200/90 text-sm mt-2 font-medium">Create your account to get started</p>
        </div>

        {/* Clerk card - solid dark glass for better contrast */}
        <div className="auth-dark-card w-full rounded-2xl bg-slate-900/90 backdrop-blur-xl border border-white/20 shadow-2xl p-6 sm:p-8">
          <SignUp
            appearance={{
              baseTheme: dark,
              layout: {
        ...
        <p className="text-slate-400 text-xs mt-6 text-center">Secure sign-up with Clerk</p>
      </div>
    </div>
  );
}
